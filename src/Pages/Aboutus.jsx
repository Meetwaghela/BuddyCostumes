        ...
        <div className="overflow-hidden about-us-container dark:bg-gray-900 dark:text-white mb-20">
            ...
            <div className="content-section animate-slideUp">
                ...
                <p className="dark:bg-gray-900 dark:text-white">
                    ...
                    Our team is composed of skilled designers and makers committed to bringing your vision to life for both individual and group needs. 
                    We take pride in consistently exceeding client expectations.
                </p>
                ...
                <p>
                    Beginning with modest steps, <b>Buddys Costume</b> has evolved into a trusted source for high-quality and uniquely embellished costumes. 
                    Our in-house expertise in stonework and fabric services has allowed us to offer unparalleled customization and build long-term partnerships, 
                    leading to substantial growth throughout the years.
                </p>
            </div>

            {/* Team Section (2 Members Centered) */}
            <div className="team-section animate-fadeIn">
                <h2 className="text-3xl text-center mt-10"><b>Meet Our Team</b></h2>
                <div className="team-container flex flex-col md:flex-row justify-center gap-8 mt-8">
                    <div className="team-member hover:shadow-lg transition-all duration-500 max-w-sm">
                        <img src={JP} alt="Shailesh Waghela" className="team-image rounded-full mx-auto" />
                        <div className="team-info text-center">
                            <h3>Shailesh Waghela</h3>
                            <p>Owner & Consultant</p>
                            <p>
                                Led by Shailesh, who brings over 15 years of meticulous craftsmanship to the table, our team provides top-quality costume creations 
                                for all your needs. His expertise ensures every detail, from concept to completion, is handled with precision and delivered on time.
                            </p>
                        </div>
                    </div>
                    <div className="team-member hover:shadow-lg transition-all duration-500 max-w-sm">
                        <img src={meet} alt="Meet Waghela" className="team-image rounded-full mx-auto" />
                        <div className="team-info text-center">
                            <h3>Meet Waghela</h3>
                            <p>Billing & Account Manager</p>
                            <p>
                                Meet excels in managing client accounts and billing, ensuring a smooth and transparent process for your custom costume order. 
                                He's dedicated to providing clear communication and helping you understand all costs involved in bringing your vision to life.
                            </p>
                        </div>
                    </div>
                </div>
